...
{
  return new (this._getT())(new WhereIterable(this, predicate));
};
...
{
  return new (this._getT())(new SelectIterable(this, predicate));
};
...
{
  return new (this._getT())(new ConcatIterable(this, other));
};
...
{
  return new (this._getT())(new DistinctIterable(this, select || identity));
};
...
{
  return new (this._getT())(new LimitIterable(this, count));
};
...
{
  return new (this._getT())(new LimitIterable(this, 0, count));
};
...
{
  return new (this._getT())(new LimitWhileIterable(this, predicate, null));
};
...
{
  return new (this._getT())(new LimitWhileIterable(this, null, predicate));
};
...
{
  return new (this._getT())(new ReverseIterable(this));
};
...
{
  return new (this._getT())(new SelectManyIterable(
    this,
    collectionSelector,
    resultSelector)
  );
...
{
  return new (this._getT())(new IntersectIterable(this, other)).distinct();
};
...
{
  return new (this._getT())(new ExceptIterable(this, other)).distinct();
};
...
{
  return new (this._getT())(new OrderByIterable(this, keySelector, false));
};
...
{
  return new (this._getT())(new OrderByIterable(this, keySelector, true));
};
...
/**
 * Used when chaining, can be overriden in the case where we don't want to
 * perpetuate the current Sequence subtype (such as specialized sequences like
 * GroupSequence etc)
 * @private
 * @return {Function}
 */
Sequence.prototype._getT = function()
{
